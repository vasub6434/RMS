    ...
    #warning { display: none; }
     ...
     function addbecondata() 
     {
    	 ...
    	 var jsonData = function( form ) {
    		 ...
    		 callPUTJSONAjax("admin/parameter/"+$("#cid").val(),jsonData( postForm ),savejsondata); 
     }
 ...
 function savejsondata(JSONObject) 
 {
	...
	// alert(JSONObject+"         "+JSONObject['status']);
     ...
     $(document).ready(function() {
    	 ...
    	 callGETJSONAjax("admin/parameter/"+$("#cid").val(),getobjectjsondata); 
    	 
     });
     function getobjectjsondata(JSONObject)
     {
    	// alert("prmname::  "+JSONObject['prmname']);
