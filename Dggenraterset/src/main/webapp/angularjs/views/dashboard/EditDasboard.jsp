    ...
    #warning { display: none; }
     ...
     function addbecondata() 
     {
    	 ...
    	 var jsonData = function( form ) {
    		 ...
    		 callPUTJSONAjax("admin/Dashboard/"+$("#cid").val(),jsonData( postForm ),savejsondata); 
     }
 ...
 function savejsondata(JSONObject) 
 {
	...
	// alert(JSONObject+"         "+JSONObject['status']);
     ...
     $(document).ready(function() {
    	 ...
    	 callGETJSONAjax("admin/Dashboard/"+$("#cid").val(),getobjectjsondata); 
    	 
     });
     function getobjectjsondata(JSONObject)
     {
    	$("#dashboardname").val(JSONObject['dashboardname']);
     }
     </script>
