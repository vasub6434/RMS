...
public class CV2EnergyMeterDevice {

  
	private static final Logger log = Logger.getLogger(CV2EnergyMeterDevice.class);
	static SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyHHmmss");
	public static class HandlerCV2EnergyMeterDevice extends SimpleChannelUpstreamHandler  {
		...
		public void messageReceived(ChannelHandlerContext ctx, MessageEvent e)
			...
			//	log.info("CV2EnergyMeterDevice "+imei+" GPS :: $GPRMC String");
				...
				log.info("CV2EnergyMeterDevice length :: "+imei+" "+track.toString().length());
				if(track!=null || track.toString().length()!=0)
				{   
			...
			//	 List<String> analog1NameList = new ArrayList<>(Arrays.asList(analog1));
			    ...
			    if (msgary[3].contains("1")) {   
				      ...
				      //log.info("CV2EnergyMeterDevice Analog  :: "+Arrays.toString(msgStringArray));
