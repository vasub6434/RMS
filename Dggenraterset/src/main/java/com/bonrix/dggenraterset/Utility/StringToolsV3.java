  ...
  //private static final String DefaultCharEncoding     = CharEncoding_8859_1;
    ...
    **/
    public static String getCharacterEncoding()
    {
        try {
            ...
            return !StringToolsV3.isBlank(charSet)? charSet : CharEncoding_UTF_8;
        } catch (Throwable th) {
    ...
    **/
    public static byte[] getBytes(String s)
    {
        if (s != null) {
            try {
                return s.getBytes(StringToolsV3.getCharacterEncoding());
...
//                Print.logStackTrace("Charset not found: " + StringTools.getCharacterEncoding());
    ...
    **/
    ...
    {
        return StringToolsV3.isNumeric(s, false);
    }
    ...
    public static boolean isNumeric(String s, boolean inclHex)
    {
        if (s == null) {
            ...
            for (int i = 0; i < ch.length; i++) {
                ...
                if (inclHex && StringToolsV3.isHexDigit(ch[i])) {
                    // continue;
                } else {
                    return false;
                }
    ...
    **/
    ...
    {
        return StringToolsV3.isPrintableASCII(b,true);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toStringValue(b, 0, -1, repUnp);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toStringValue(b, 0, -1);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toStringValue(b, ofs, -1);
    }
    ...
    **/
    ...
    {
        if (b != null) {
            if ((repUnp != (char)0) && !StringToolsV3.isPrintableASCII(b,true)) {
            ...
            return StringToolsV3.toStringValue(b, ofs, len);
        } else {
            return null;
        }
    }
    ...
    **/
    public static String toStringValue(byte b[], int ofs, int len)
    {
        ...
        if (len == 0) {
            ...
            try {
                return new String(b, ofs, len, StringToolsV3.getCharacterEncoding());
            } catch (Throwable t) {
        ...
        if (s != null) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if ((ch < 0x0020) || (ch > 0x007e)) {
                    sb.append('\\');
                    sb.append('u');
                    sb.append(StringToolsV3.hexNybble((ch >> 12) & 0xF));
                    sb.append(StringToolsV3.hexNybble((ch >>  8) & 0xF));
                    sb.append(StringToolsV3.hexNybble((ch >>  4) & 0xF));
                    sb.append(StringToolsV3.hexNybble( ch        & 0xF));
                } else {
                    sb.append(ch);
                }
            }
    ...
    **/
    public static String blankDefault(Object target, String dft)
    {
        if (target == null) {
            ...
            return !StringToolsV3.isBlank(t)? t : dft;
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.isBlank(target)? dft : target;
    }
    ...
    **/
    ...
    {
        return (s != null)? StringToolsV3.trimLeading(s.toString()) : "";
    }
    ...
    **/
    ...
    {
        return (s != null)? StringToolsV3.trimTrailing(s.toString()) : "";
    }
    ...
    **/
    ...
    {
        return StringToolsV3.quoteString(s, '\"');
    }
    ...
    public static String encodeCSV(String d[], boolean checkTextQuote)
    {
        if (d != null) {
            ...
            for (int i = 0; i < d.length; i++) {
                ...
                sb.append(StringToolsV3.quoteCSVString(t));
            }
            return sb.toString();
        } else {
            return "";
    ...
    **/
    ...
    {
        return StringToolsV3.encodeCSV(d, false);
    }
    ...
    **/
    ...
    {
        StringBuffer sb = new StringBuffer();
        StringToolsV3.parseQuote(s.toCharArray(), 0, sb);
        return sb.toString();
    }
    ...
    public static double[] parseDouble(Object data[], double dft)
    {
        if (data == null) {
            ...
            for (int i = 0; i < data.length; i++) {
                valList[i] = StringToolsV3.parseDouble(data[i], dft);
            }
            return valList;
        }
    }
    ...
    **/
    public static double parseDouble(Object data, double dft)
    {
        ...
        if (data instanceof Number) {
            ...
            return StringToolsV3.parseDouble(data.toString(), dft);
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.parseDouble(new FilterNumber(data, Double.class), dft);
    }
    ...
    **/
    public static boolean isDouble(Object data, boolean strict)
    {
        ...
        if (data instanceof Number) {
            ...
            return StringToolsV3.isDouble(data.toString(), strict);
        }
    }
    ...
    **/
    public static float parseFloat(Object data, float dft)
    {
        ...
        if (data instanceof Number) {
            ...
            return StringToolsV3.parseFloat(data.toString(), dft);
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.parseFloat(new FilterNumber(data, Float.class), dft);
    }
    ...
    **/
    public static boolean isFloat(Object data, boolean strict)
    {
        ...
        if (data instanceof Number) {
            ...
            return StringToolsV3.isFloat(data.toString(), strict);
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.parseLong(new FilterNumber(data, Long.class), dft);
    }
    ...
    **/
    public static long parseLong(FilterNumber num, long dft)
    {
        if ((num != null) && num.supportsType(Long.class)) {
            if (num.isHex()) {
                return StringToolsV3.parseHexLong(num.getValueString(), dft);
            } else {
                try {
    ...
    **/
    public static boolean isLong(Object data, boolean strict)
    {
        ...
        if (data instanceof Number) {
            ...
            return StringToolsV3.isLong(data.toString(), strict);
        }
    }
    ...
    **/
    public static int[] parseInt(Object data[], int dft)
    {
        if (data == null) {
            ...
            for (int i = 0; i < data.length; i++) {
                valList[i] = StringToolsV3.parseInt(data[i], dft);
            }
            return valList;
        }
    }
    ...
    **/
    public static int parseInt(Object data, int dft)
    {
        ...
        if (data instanceof Number) {
            ...
            return StringToolsV3.parseInt(data.toString(), dft);
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.parseInt(new FilterNumber(data, Integer.class), dft);
    }
    ...
    **/
    public static int parseInt(FilterNumber num, int dft)
    {
        if ((num != null) && num.supportsType(Integer.class)) {
            if (num.isHex()) {
                return (int)StringToolsV3.parseHexLong(num.getValueString(), dft);
            } else {
                try {
    ...
    **/
    public static boolean isInt(Object data, boolean strict)
    {
        ...
        if (data instanceof Number) {
            ...
            return StringToolsV3.isInt(data.toString(), strict);
        }
    }
    ...
    **/
    public static int parseShort(Object data, short dft)
    {
        ...
        if (data instanceof Number) {
            ...
            return StringToolsV3.parseShort(data.toString(), dft);
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.parseShort(new FilterNumber(data, Short.class), dft);
    }
    ...
    **/
    public static short parseShort(FilterNumber num, short dft)
    {
        if ((num != null) && num.supportsType(Short.class)) {
            if (num.isHex()) {
                return (short)StringToolsV3.parseHexLong(num.getValueString(), dft);
            } else {
                try {
    ...
    **/
    public static boolean isShort(Object data, boolean strict)
    {
        ...
        if (data instanceof Number) {
            ...
            return StringToolsV3.isShort(data.toString(), strict);
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.parseBigInteger(new FilterNumber(data, BigInteger.class), dft);
    }
    ...
    **/
    public static boolean isBigInteger(Object data, boolean strict)
    {
        ...
        if (data instanceof Number) {
            ...
            return StringToolsV3.isBigInteger(data.toString(), strict);
        }
    }
    ...
    **/
    public static class FilterNumber
    {
        ...
        public byte[] getHexBytes() {
            if (this.isHex) {
                return StringToolsV3.parseHex(this.getValueString(), new byte[0]);
            } else {
                // not tested yet
    ...
    **/
    public static boolean parseBoolean(Object data, boolean dft)
    {
        ...
        if (data instanceof Boolean) {
            ...
            return StringToolsV3.parseBoolean(data.toString(), dft);
        }
    }
    ...
    **/
    public static boolean isBoolean(Object data, boolean strict)
    {
        ...
        if (data instanceof Boolean) {
            ...
            return StringToolsV3.isBoolean(data.toString(), strict);
        }
    }
    ...
    **/
    public static Dimension parseDimension(String data, Dimension dft)
    {
        ...
        if (p > 0) {
            int w = StringToolsV3.parseInt(data.substring(0,p),0);
            int h = StringToolsV3.parseInt(data.substring(p+1),0);
    ...
    **/
    ...
    {
        return StringToolsV3.HEX.indexOf(Character.toUpperCase(ch));
    }
    ...
    **/
    ...
    {
        return (int)StringToolsV3.parseHexLong(data, (long)dft);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.parseHexLong(data, dft);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.formatHexString(b, 0, -1, 16, true, null);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.formatHexString(b, 0, -1, blockLen, true, null);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.formatHexString(b, 0, -1, blockLen, true, sb);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toHexString(b,null).toString();
    }
    ...
    **/
    public static StringBuffer toHexString(byte b[], int ofs, int len, StringBuffer sb)
    {
        ...
        if (b != null) {
            ...
            for (int i = bstrt; i < bstop; i++) { StringToolsV3.toHexString(b[i], sb); }
        }
        return sb;
    }
    ...
    **/
    public static StringBuffer toHexString(byte b[], StringBuffer sb)
    {
        return StringToolsV3.toHexString(b,0,-1,sb);
    }
    ...
    **/
    public static String toHexString(byte b[])
    {
        return StringToolsV3.toHexString(b,0,-1,null).toString();
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toHexString(b,ofs,len,null).toString();
    }
    ...
    **/
    public static String toHexString(BigInteger val, int bitLen)
    {
        ...
        if (nybbleLen > hex.length()) {
            hex.insert(0, StringToolsV3.replicateString("0", nybbleLen - hex.length()));
        }
        return hex.toString();
    ...
    **/
    ...
    {
        return StringToolsV3.toHexString(val, -1);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toHexString(val, 64);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toHexString((long)val & 0xFFFFFFFF, 32);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toHexString((long)val & 0xFFFF, 16);
    }
    ...
    **/
    public static String toHexString(Number val)
    {
        ...
        if (val instanceof Byte) {
            return StringToolsV3.toHexString(val.byteValue());
        } else
        if (val instanceof Short) {
            return StringToolsV3.toHexString(val.shortValue());
        } else
        if (val instanceof Integer) {
            return StringToolsV3.toHexString(val.intValue());
        } else
        if (val instanceof Long) {
            return StringToolsV3.toHexString(val.longValue());
        } else
    ...
    **/
    public static String toHexString(Number val, int bitLen)
    {
        ...
        if (val instanceof BigInteger) {
            return StringToolsV3.toHexString(val, bitLen);
        } else {
            return StringToolsV3.toHexString(val.longValue(), bitLen);
        } 
    }
    ...
    public static StringBuffer toBinaryString(byte b[], int ofs, int len, StringBuffer sb)
    {
        ...
        if (b != null) {
            ...
            for (int i = bstrt; i < bstop; i++) {
                if (i > 0) { sb.append(" "); }
                StringToolsV3.toBinaryString(b[i], sb);
            }
        }
        return sb;
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toBinaryString(b,new StringBuffer()).toString();
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toBinaryString(b,ofs,len,null).toString();
    }
    ...
    **/
    public static StringBuffer toBinaryString(byte b, StringBuffer sb)
    {
        return StringToolsV3.toBinaryString((long)b, 8, sb);
    }
    ...
    **/
    public static String toBinaryString(byte b)
    {
        return StringToolsV3.toBinaryString(b, null).toString();
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toBinaryString((long)i, 32, sb);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toBinaryString(i, null).toString();
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toBinaryString(i, -1, sb);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.toBinaryString(i, -1, null).toString();
    }
    ...
    **/
    ...
    {
        return StringToolsV3.encodeArray(list, 0, -1, delim, alwaysQuote);
    }
    ...
    **/
    public static String encodeArray(Object list, int ofs, int max, char delim, boolean alwaysQuote)
    {
        ...
        if (list instanceof Object[]) {
            ...
            return StringToolsV3.encodeArray((Object[])list, ofs, max, delim, alwaysQuote);
        } else 
        if (list.getClass().isArray()) {
            ...
            if ((ofs <= 0) && (max != 0)) {
                ...
                return alwaysQuote? StringToolsV3.quoteString(list.toString()) : list.toString();
            } else {
    ...
    **/
    ...
    {
        return StringToolsV3.encodeArray(list, ARRAY_DELIM, true);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.encodeArray(list, ARRAY_DELIM, alwaysQuote);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.encodeArray((Object[])list, ARRAY_DELIM, true);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.encodeArray((Object[])list, ARRAY_DELIM, alwaysQuote);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.replaceChars(src, String.valueOf(ch), String.valueOf(repChar));
    }
    ...
    **/
    ...
    {
        return StringToolsV3.replaceChars(src, chars, String.valueOf(repChar));
    }
    ...
    **/
    ...
    {
        return StringToolsV3.replaceWhitespace(src, String.valueOf(repChar));
    }
    ...
    **/
    ...
    {
        if (StringToolsV3.isBlank(keyStart)) { keyStart = KEY_START; }
        if (StringToolsV3.isBlank(keyEnd  )) { keyEnd   = KEY_END  ; }
        if (StringToolsV3.isBlank(dftDelim)) { dftDelim = DFT_DELIM; }
        if (StringToolsV3.isBlank(argDelim)) { argDelim = ARG_DELIM; }
    ...
    **/
    ...
    {
        if (s == null) {
            return StringToolsV3.replicateString(String.valueOf(padChar), len);
        } else
        if (s.length() >= len) {
            return s;
        } else {
            return s + StringToolsV3.replicateString(String.valueOf(padChar), len - s.length());
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.padRight(s, ' ', len);
    }
    ...
    **/
    public static String padLeft(String s, char padChar, int len)
    {
        ...
        if (s.length() >= len) {
            ...
            return StringToolsV3.replicateString(String.valueOf(padChar), len - s.length()) + s;
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.padLeft(s, ' ', len);
    }
    ...
    **/
    ...
    {
        if (text != null) {
            return StringToolsV3.encodeNewline(new StringBuffer(text)).toString();
        } else {
            return null;
        }
    }
    ...
    **/
    ...
    {
        if (text != null) {
            return StringToolsV3.decodeNewline(new StringBuffer(text)).toString();
        } else {
            return null;
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.replace(sb,"\\n","\n");
    }
    ...
    **/
    ...
    {
        if (text != null) {
            return StringToolsV3.replace(new StringBuffer(text), key, val).toString();
        } else {
            return null;
        }
    }
    ...
    **/
    ...
    {
        String s = StringToolsV3.regexReplace(target.toString(), regexKey, val);
    ...
    **/
    ...
    {
        return StringToolsV3.regexIndexOf(target, regex, 0);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.compare(b1, b2, -1);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.compare(b1, ((s != null)? StringToolsV3.getBytes(s) : null), -1);
    }
    ...
    **/
    public static boolean compareEquals(byte b1[], byte b2[], int len)
    {
        ...
        if ((b1 == null) || (b2 == null)) {
            ...
            return (StringToolsV3.compare(b1, b2, len) == 0);
        }
    }
    ...
    **/
    ...
    {
        return StringToolsV3.compareEquals(b1, b2, -1);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.compareEquals(b, ((s != null)? StringToolsV3.getBytes(s) : null), -1);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.diff(b1, b2, -1);
    }
    ...
    **/
    ...
    {
        if (StringToolsV3.isBlank(fmt)) { fmt = "0"; }
...
//                Print.logException("Format exception [" + fmt + "]", th);
            ...
            s = StringToolsV3._getFormatter(fmt).format(val);
        }
        if (fieldSize > s.length()) {
            s = StringToolsV3.rightAlign(s, fieldSize);
        }
        return s;
    }
    ...
    **/
    public static String format(BigInteger val, String fmt, int fieldSize)
    {
        ...
        if (fmt.startsWith("x") || fmt.startsWith("X")) {
            int byteLen = StringToolsV3.parseInt(fmt.substring(1), -1);
            String hex = StringToolsV3.toHexString(val, byteLen * 8); // uppercase
            if (fmt.startsWith("x")) { hex = hex.toLowerCase(); }
            s = "0x" + hex;
        } else
        if (fmt.startsWith("hex") || fmt.startsWith("HEX")) {
            int byteLen = StringToolsV3.parseInt(fmt.substring(3), -1);
            String hex = StringToolsV3.toHexString(val, byteLen * 8); // uppercase
    ...
    **/
    ...
    {
        return StringToolsV3.format((long)val, fmt, -1);
    }
    ...
    **/
    ...
    {
        return StringToolsV3.format((long)val, fmt, fieldSize);
    }
  ...
  //    System.out.println("_lat-before"+s);
     ...
     public static double parseLatitudeBG101(String s, String d) {
    	  //    System.out.println("_lat-before"+s);
    	         double _lat = StringTools.parseDouble(s, 99999.0);
